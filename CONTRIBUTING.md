...
## STEP-0 : Key Points to remember :
  - Look at the previous projects and get some idea from them [Previous](https://github.com/GDSC-IET-LUCKNOW/PROJECTS-HUB-Hacktoberfest-2022)
  - Suppose you want to contribute one projet to one particular domain then first check is there any [Projects](https://github.com/GDSC-IET-LUCKNOW/PROJECTS-HUB-Hacktoberfest-2022) exits with the same language or not.
  ...
  - Please don't add any License under your project. This repo already under MIT License.
    ...
    ## **Flow** :
     #PROJECT's HUB 
     - Choose your domain or Techstack. 
     - Create a folder with your project name. 
     - Create a awesome readme file.
     - Send in a pull request.
     
      
## STEP-1 : Find an issue
  - Take a look at the Existing [Issues](https://github.com/GDSC-IET-LUCKNOW/PROJECTS-HUB-Hacktoberfest-2022/issues) and [Pull Requests](https://github.com/GDSC-IET-LUCKNOW/PROJECTS-HUB-Hacktoberfest-2022/pulls) as yours may be a duplicate  or create your own [Issues!](https://github.com/Kushal997-das/Project-Guidance/issues) 
